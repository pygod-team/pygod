# -*- coding: utf-8 -*-
""" Example code Multilayer Perceptron Autoencoder
"""
...
parser.add_argument('--dataset', type=str, default='Cora',
                    help='graph dataset to be evaluated, [Cora, Pubmed, '
                         'Citeseer] ')
parser.add_argument('--channel_list', type=list, default=[16, 16],
                    help='dimensions of hidden layers (default: 16)')
parser.add_argument('--hidden_size', type=int, default=16,
                    help='dimension of hidden embedding (default: 16)')
parser.add_argument('--num_layers', type=int, default=2,
                    help='number of linear layers in MLP (default: 2)')
...
parser.add_argument("--patience", type=int, default=10,
                    help="early stopping patience, 0 for"
                         "disabling early stopping (default: 10)")
