...
class DOMINANT_S(BaseDetector):
    ...
    def __init__(self,
                 ...
                 num_neigh=-1,
                 verbose=False):
        super(DOMINANT_S, self).__init__(contamination=contamination)
    ...
    def fit(self, G, y_true=None):
        ...
        loader = NeighborSampler(G.edge_index,
                                 sizes=[self.num_neigh] * self.num_layers,
                                 batch_size=self.batch_size,
...
class DOMINANT_Base(nn.Module):
    def __init__(self,
        ...
        # TODO replace the model with GraphSAGE
