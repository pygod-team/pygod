...
class TestMetric(unittest.TestCase):
    ...
    def setUp(self):
        self.y = np.array([0, 0, 1, 1, 1, 0, 0, 0, 1])
        self.score = np.array([0.1, 0.2, 0.2, 0.8, 0.2, 0.5, 0.7, 0.9, 1.])
        self.manual_labels = np.array([0, 0, 0, 1, 0, 0, 1, 1, 1])
    ...
    def test_eval_f1(self):
        assert_allclose(f1_score([self.y], [self.score]),
                        eval_f1(self.y, self.score))
